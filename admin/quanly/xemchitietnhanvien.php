...
?>
   ...
   $query="SELECT ID_Nhanvienbanhang, Tennhanvien , Sdt, Diachi, Tendangnhap, Matkhau, Tendangnhap, Matkhau from nhanvienbanhang 
                        ...
                        <form class="form-horizontal"  method="POST" action="<?php include 'xulysuanhanvien.php'?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="account" value="<?php echo $row["Tendangnhap"] ?>" required disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Mật khẩu</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="pass" value="<?php echo $row["Matkhau"] ?>" required disabled>
                                    </div>
                                </div>
                                
                                <div class="box-footer">
                                    <a href="qlynhanvien.php"><button type="button" name="cancel" class="btn btn-default">Quay lại</button></a>
